 ...
 */
final class Version20210601120725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pro (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, profession_id INT NOT NULL, presentation VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
